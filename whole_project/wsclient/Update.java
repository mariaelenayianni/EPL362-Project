...
/**
 * This class represents an UI for update transactions
...
public class Update {
	...
	public Update() throws MalformedURLException {
		...
		Update.caseSelected = false;
		Update.strategySelected = false;
		Update.legalOpinionIsSelected = false;
		Update.detailedIsEmpty = true;
		Update.distibutesIsEmpty = true;
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					ws.xml pre=new ws.xml();
					pre=getTransactionforupdate();
					//System.out.println();
					frame = new JFrame();
					...
					comboBox.setSelectedItem(pre.t.get(0)[8]);
					...
					comboBox_1.setSelectedIndex(Integer.parseInt(pre.t.get(0)[1]));
					...
					comboBox_2.setSelectedIndex(Integer.parseInt(pre.t.get(0)[9]));
					...
					comboBox_2.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent arg0) {
							if (comboBox_2.getSelectedIndex() != 0) {
								// HERE
								Update.legalOpinionIsSelected = true;
							} else {
								Update.legalOpinionIsSelected = false;
					...
					textField_1.setText(pre.t.get(0)[7]);
					textField_1.getDocument().addDocumentListener(new DocumentListener() {
						...
						/**
						 * This functions handles the change of the text field 1
						 */
					...
					textField_2.setText(pre.t.get(0)[4]);
					textField_2.getDocument().addDocumentListener(new DocumentListener() {
						...
						/**
						 * This function handles the change of the text field 2
						 */
						private void changed() {
							if (textField_2.getText().equals("")) {
								Update.distibutesIsEmpty = true;
							} else {
								Update.distibutesIsEmpty = false;
							}
	...
	/**
	 * This function requests to get cases
	 * @return
	 */
	...
	/**
	 * This function requests to get legal opinions
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * This function returns the side effects
	 * @param strategyID
	 * @return
	 */
	...
	/**
	 * This function takes actions when the submit button pressed
	 * Espessialy,requests for update transaction
	 * @throws Exception
	 */
	private void submitAction() throws Exception {
		...
		int complete = 0;
		if (Update.caseSelected && Update.strategySelected && Update.legalOpinionIsSelected
				&& !Update.detailedIsEmpty && !Update.distibutesIsEmpty) {
			complete = 1;
		}
		...
		this.ls.UpdateTransactions(selectedCase, selectedStrategy, selectedLegalOpinion, details, disputes, complete,
				globals.appointment1);
		frame.dispose();
	}
	
	/**
	 * This function requests to get transaction for update
	 * @return
	 * @throws Exception
	 * 
	 */
	private ws.xml getTransactionforupdate() throws Exception {
		return ls.getTransactionforUpdate(globals.appointment);
