...
public class FreeRegistrationDialog extends JDialog {
	...
	public FreeRegistrationDialog(JDialog parent) {
				...
				if (ValidateRequiredField(userNameField.getText(),passwordField_1.getPassword(),passwordField_2.getPassword())){
					if (ValidateName(firstNameField.getText(),lastNameField.getText())){
						if (ValidateEmail(emailField.getText())){
							...
							if (lName == null) lName = "";
							if (email == null) email = "";
							FreeRegistrationEvent ev = new FreeRegistrationEvent(this, username, password,fName,lName,email,role);
		...
		roleField.addItem("Legal Staff");
		roleField.addItem("Lecal Records Staff");
		roleField.addItem("Receptionist");
		roleField.addItem("Head Office Managment");
